...
export const navigation: NavItem[] = [
  ...
  { label: "Toko", href: "/stores", icon: Store, adminOnly: true, group: "Retail & Invoice" },
  { label: "Invoice", href: "/invoices", icon: FileText, adminOnly: true, group: "Retail & Invoice" },
  { label: "Laporan Mingguan", href: "/weekly-report", icon: Sprout, adminOnly: true, group: "Program Lapangan" },
