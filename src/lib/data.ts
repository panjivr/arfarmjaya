...
export const navigation: NavItem[] = [
  ...
  { label: "Mutasi & Sortir", href: "/lele/mutasi", icon: ArrowLeftRight, adminOnly: true, group: "Budidaya Lele" },
  { label: "Keuangan Lele", href: "/lele/keuangan", icon: Wallet, adminOnly: true, group: "Budidaya Lele" },
